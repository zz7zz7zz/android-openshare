...
public class T_StatusUploadUrl extends TenNetRunnable {
	...
	public T_StatusUploadUrl(Bundle mBundle,IOpenResponse listener)
	{
	...
	public void loadData() {
		...
		this.reqUrl=TenShareImpl.URL_SERVER+"/t/add_pic_url";
...
//		this.formMultParamList.add(new BasicNameValuePair("wei",mBundle.getString(OpenManager.BUNDLE_KEY_LATITUDE)));
		...
		this.formMultParamList.add(new BasicNameValuePair("pic_url",mBundle.getString(OpenManager.BUNDLE_KEY_PICURL)));
...
LogUtil.v("T_StatusUploadUrlMsg handleData():", "---"+str);
