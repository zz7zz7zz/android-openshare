...
import com.open.share.renren.api.RenNetRunnable;
 ...
 *
 */
public final class RenHttpUtil
{
	...
	public static HttpEntity handleGet(RenNetRunnable msg)
	{
		try {
...
LogUtil.v("RenHttpUtil handleGet()", "code"+code);
...
//	        	}
	...
	public static HttpEntity handlePost(RenNetRunnable msg)
	{
		try {
...
LogUtil.v("handlePost", HttpParamUtil.getRequestUrl(msg.reqUrl, msg.reqGetParams));
			...
			{
				int code=mStatusLine.getStatusCode();
LogUtil.v("RenHttpUtil handlePost()", "code"+code);
//				if(code == HttpStatus.SC_OK) 
//				{
//					return response.getEntity();
//				}
