...
import com.open.share.tencent.api.TenNetRunnable;
 ...
 *
 */
public final class TenHttpUtil
{
	...
	public static HttpEntity handleGet(TenNetRunnable msg)
	{
		try {
...
LogUtil.v("TenHttpUtil handleGet()", "code"+code);
...
//	        	}
	...
	public static HttpEntity handlePost(TenNetRunnable msg)
	{
		try {
...
LogUtil.v("handlePost", HttpParamUtil.getRequestUrl(msg.reqUrl, msg.reqGetParams));
			...
			MultipartEntity entity=msg.getUploadEntity();
			if(null!=entity)
			{
				mHttpPost.setEntity(entity);
			}
			else if(null!=msg.reqPostDate)
			{
			...
			{
				int code=mStatusLine.getStatusCode();
LogUtil.v("TenHttpUtil handlePost()", "code"+code);
//				if(code == HttpStatus.SC_OK) 
//				{
//					return response.getEntity();
//				}
